...
export const defineRegisterTool = <
...
export const defineRegisterPrompt = <Args extends PromptArgsRawShape>(
    name: string,
    config: {
        title?: string;
        description?: string;
...
export const defineRegisterResource = (
    name: string,
...
export const defineRegisterResourceV2 = (
    name: string,
